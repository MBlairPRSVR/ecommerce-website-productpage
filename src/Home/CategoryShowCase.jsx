...
import Rating from '../components/Rating'; // Assuming Rating component is correctly imported
                        ...
                        <div className="course-content">
                            ...
                            <div className="course-footer">
                                <div className="course-author">
                                    {/* Assuming "brand" should be displayed here */}
        ...
        <div className="course-section style-3 padding-tb">
            ...
            <div className="container">
                ...
                <div className="section-wrapper">
                    <div className="row g-4 justify-content-center row-cols-xl-4 row-cols-lg-3 rows-col-md-2 row-cols-1
                    course-filter">
                    {
